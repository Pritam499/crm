...
import { authMiddleware } from "../../middlewares/auth.js"; // a small wrapper to handle express-validator results
...
// Delete
router.delete("/:id", [param("id").isUUID()], authMiddleware, deleteLead);
